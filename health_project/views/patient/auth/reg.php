...
<div class="container">
    <div class="row">
	    <div class="col-md-6 col-md-offset-3" id="form">
		     <center><b  class="registration">Patient Registration Form</b></center>
			...
			<div class="form-group">
				    <label> Age:</label>
				<input type="age" name="age" class="form-control text" id="age" placeholder="Enter Age"> 
            ...
            <div class="form-group">
				   ...
				   <select name="gender" id="gender" class="form-control text">
                ...
                <input type="reset" class="btn btn-danger" value="Reset">
				  ...
				  <a href="patient_login.php" class="text-center">Go to login</a>
		...
		<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/js/bootstrap.min.js" integrity="sha384-wfSDF2E50Y2D1uUdj0O3uMBJnjuUD4Ih7YwaYd1iqfktj0Uod8GCExl3Og8ifwB6" crossorigin="anonymous"></script>
           ...
           <?php
			   ...
			   include '../../../db/connection.php';
				...
				$sql="INSERT INTO patient_info (name,number,email,age,gender,address,password, status) 
				              VALUES('$Name','$Number','$Email','$Age','$Gender','$Address','$Pass', 'false')";
